...
public class Notas extends javax.swing.JFrame {
    ...
    public Notas() {
        ...
        String sql = "INSERT INTO notas(nome, disciplina, semestre, teste, docente, nota) VALUES(?,?,?,?,?,?)";

        try {
            pst = conexao.prepareStatement(sql);

            pst.setString(1, jComboNomes.getSelectedItem().toString());
            pst.setString(2, jComboDisciplina.getSelectedItem().toString());
            pst.setString(3, jComboSemestre.getSelectedItem().toString());
            pst.setString(4, jComboAnoAcademico.getSelectedItem().toString());
            pst.setString(5, txtNomeDocente.getText());
            pst.setString(6, txtNota.getText());
            
            if (txtNomeDocente.getText().isEmpty() ) {
                JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatorios!");
            } else {

                int adicionado = pst.executeUpdate();
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Nota lacanda com sucesso!");
                    preencherTabela();
        ...
        String sql = "SELECT nome FROM estudantes;";
...
//                txtNome.setText(rs.getString(2));
                jComboNomes.setSelectedItem(rs.getString(3));
       ...
       private void actualizar() {
        ...
        try {
         ...
         //   pst.setString(1, txtNome.getText());
            pst.setString(2, jComboNomes.getSelectedItem().toString());
...
//           txtNome.setText("");
         ...
         private void preencherComboDisciplina() {
    ...
    private void initComponents() {
        ...
        jComboDisciplina = new javax.swing.JComboBox<String>();
        ...
        jLabel5.setText("LANCAMENTO DE NOTAS");
        ...
        jLabel9.setText("NOME DOS ESTUDANTES");
        ...
        TabelaDisciplina.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOME", "SEMESTRE", "TESTE", "DISCIPLINA"
            }
        ));
        jScrollPane1.setViewportView(TabelaDisciplina);

        jComboAnoAcademico.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TESTE 1", "TESTE 2", "TESTE 3", "AVALICAO CONTINUA", "TRABALHO 1", "TRABALHO 2", "TRABALHO SEMESTRAL" }));
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGap(22, 22, 22)
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jComboNomes, javax.swing.GroupLayout.PREFERRED_SIZE, 432, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(jComboDisciplina, javax.swing.GroupLayout.PREFERRED_SIZE, 388, javax.swing.GroupLayout.PREFERRED_SIZE))))))
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jComboDisciplina, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(12, 12, 12)
...
//        MenuPrincipal menu = new MenuPrincipal();
   //     menu.setVisible(true);
    ...
    private javax.swing.JComboBox<String> jComboDisciplina;
