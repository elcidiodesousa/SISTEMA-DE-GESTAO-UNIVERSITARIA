...
public class CursoForm extends javax.swing.JFrame {
    ...
    private void preencherTabela() {
        ...
        try {
            ...
            TabelaCurso.setModel(DbUtils.resultSetToTableModel(rs));
     ...
     private void limpar() {
        ...
        txtFacul.setText("");
        txtDiretorCurso.setText("");
        
     }
    private void cadastrar() {
        String sql = "INSERT INTO curso(nome, faculdade, dirctor, valor, duracao, carga_horaria) VALUES(?,?,?,?,?,?)";

        try {
            pst = conexao.prepareStatement(sql);

            pst.setString(1, txtNomeCurso.getText());
            pst.setString(2, txtFacul.getText());
            pst.setString(3, txtDiretorCurso.getText());
            pst.setString(4, txtValor.getText());
            pst.setString(5, txtDuracao.getText());
            pst.setString(6, txtcarga.getText());

            if (txtNomeCurso.getText().isEmpty() || txtFacul.getText().isEmpty() || txtDiretorCurso.getText().isEmpty()) {
    ...
    private void Consultar() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtFacul.setText(rs.getString(3));
                txtDiretorCurso.setText(rs.getString(4));
            

            } else {
                JOptionPane.showMessageDialog(null, "Curso nao cadastrado!");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
     ...
     private void deletar() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                int linhaSelecionada = TabelaCurso.getSelectedRow();
        ...
        String sql = "UPDATE curso SET nome=?, faculdade=?, dirctor=? WHERE id=?";
    ...
    private void initComponents() {
        ...
        txtDiretorCurso = new javax.swing.JTextField();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        TabelaCurso = new javax.swing.JTable();
        jLabel18 = new javax.swing.JLabel();
        txtFacul = new javax.swing.JTextField();
        ...
        btnCadastrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/GuardarTodo.png"))); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/ESSAA.png"))); // NOI18N
        ...
        jLabel5.setText("CADASTRO DOS CURSOS");
        ...
        jLabel6.setText("DADOS DO CURSO");
        ...
        jLabel13.setText("DIRETOR DO CURSO");
        ...
        TabelaCurso.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOME", "FACULDADE", "DIRETOR DO CURSO"
            }
        ));
        ...
        jLabel18.setText("FACULDADE-DEPARTAMENTO");

        jLabel10.setBackground(new java.awt.Color(255, 255, 255));
        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("PESQ/ID");
        ...
        jLabel14.setText("CARGA HORARIA");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(143, 143, 143)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNomeCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 352, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel9))
                        .addGap(31, 31, 31)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtFacul, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel18))
                        .addGap(33, 33, 33)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtDiretorCurso, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(txtDuracao, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(txtcarga, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel18))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDiretorCurso, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel9)
                            .addComponent(jLabel10))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txtFacul, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//             MenuPrincipal menu = new MenuPrincipal();
 //       menu.setVisible(true);
    ...
    private javax.swing.JTextField txtDiretorCurso;
    private javax.swing.JTextField txtDuracao;
    private javax.swing.JTextField txtFacul;
